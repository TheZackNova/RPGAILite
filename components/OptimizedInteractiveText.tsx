...
export const OptimizedInteractiveText: React.FC<{
    ...
    if (text.startsWith('> ')) {
        return (
            <div className="font-semibold text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-pink-500 to-orange-400 leading-relaxed whitespace-pre-wrap">
                {text}
            </div>
        );
    }
