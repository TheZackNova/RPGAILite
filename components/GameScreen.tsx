...
export const GameScreen: React.FC<{ 
    ...
    }, [ai, isUsingDefaultKey, userApiKeyCount, rotateKey, parseStoryAndTags, ruleChanges]);
    ...
    }, [turnCount, cleanupStats, gameHistory]);
    ...
    return (
        <div className={`w-full h-full max-w-7xl mx-auto flex flex-col ${fontFamily} ${fontSize} bg-slate-200/50 dark:bg-slate-900/50 rounded-2xl shadow-2xl overflow-hidden`}>
            ...
            <main className="flex-grow flex flex-col md:grid md:grid-cols-3 gap-4 p-4 min-h-0">
                <StoryPanel
                    storyLog={storyLog}
                    isLoading={isLoading}
                    isAiReady={isAiReady}
