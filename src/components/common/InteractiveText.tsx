...
import { getIconForEntity } from '../../utils/EntityHelpers';
import { KnownEntities, EntityType } from '../../types';
...
export const InteractiveText: React.FC<InteractiveTextProps> = ({ text, onEntityClick, knownEntities }) => {
